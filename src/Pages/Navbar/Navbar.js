...
const Navbar = () => {
    ...
    const menuItems = <>
        <li className='btn btn-ghost normal-case text-xl text-purple-900'><Link to="/">Home</Link></li>
        <li className='btn btn-ghost normal-case text-xl text-purple-900'><Link to="/viewBlog">Blog</Link></li>
    ...
    return (
        <div class="navbar bg-primary text-primary-content justify-sticky">
            <div class="navbar-start">
                ...
                <Link to='/' class="btn btn-ghost normal-case btn btn-ghost normal-case text-2xl text-purple-900">Online Nursery Service</Link>
            </div>
